    ...
    <div>
      ...
      <div className="contain mx-6 flex flex-col items-center space-y-6 p-6">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-white mt-2">American Truck Simulator (ATS)</p>
          ...
          <div className="mt-6 space-x-2">
            <a
              href="https://steamcommunity.com/sharedfiles/filedetails/?id=3365680923"  // Replace with the actual product page link
            ...
            <a
              href="https://sharemods.com/unin4mpesaua/Realistic_Economy.zip.html"  // Replace with the actual product page link
